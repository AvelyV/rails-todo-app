...
class TaskCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_category" do
    assert_difference('TaskCategory.count') do
      post task_categories_url, params: { task_category: { category_id: @task_category.category_id, task_id: @task_category.task_id } }
    end
  ...
  test "should update task_category" do
    patch task_category_url(@task_category), params: { task_category: { category_id: @task_category.category_id, task_id: @task_category.task_id } }
